...
class Book(models.Model):
    ...
    price = models.DecimalField(max_digits=12, decimal_places=2,
                                verbose_name=_("Цена"))
    author = models.ForeignKey("bookclub.Author", on_delete=models.CASCADE,
...
class Reader(models.Model):
    ...
    books = models.ManyToManyField("bookclub.Book", verbose_name=_("Книги"),
                                   through="bookclub.BookReading")
...
class BookReading(models.Model):
    book = models.ForeignKey("bookclub.Book", on_delete=models.CASCADE,
                             verbose_name=_("Книга"),
                             related_name="bookreading_book")
    reader = models.ForeignKey("bookclub.Reader", on_delete=models.CASCADE,
